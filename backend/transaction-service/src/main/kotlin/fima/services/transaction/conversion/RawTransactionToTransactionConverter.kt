...
class RawTransactionToTransactionConverter(private val toDateConverter: RawDateToDateConverter,
                                           private val toTransactionTypeConverter: RawTypeToTransactionTypeConverter) : (RawTransaction) -> Transaction {
